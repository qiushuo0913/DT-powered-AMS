...
FilePath: /DT_powered_AMS_code/main_repara_PPI.py
Description:  DT-AMS (using PT data to correct the error caused by DT data)--- "DT-AMS" in the simulation
'''
...
if __name__ == '__main__':
    ...
    def train_eta_PPI(t, T, model, eta, data_list, context_vector_t, data_list_PT_ct, data_list_DT_ct, num_data_PT, num_data_DT, Epoch):
        ...
        for epoch in range(Epoch):
            ...
            #PPI
            total_loss_train = total_loss_train+(loss_PT-loss_DT)
    ...
    def overall_test_eta_PPI(model, eta, data_list_test, context_vector_test, csis_test, num_data_train_DT, num_data_train_PT, num_data_test):
        ...
        for t in range (scenario_config.T):
            ...
            # data_list_DT_S_multi_update =  data_list_DT_S -  data_list_DT_t  
            ...
            # tags1 = {'NtDT_%d_PPI_p%f_seed%d_S%d' % (scenario_config.train_layouts_DT, args.p, args.seed, args.S): np.average(Sum)}
